    ...
    <div class="pagetitle">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/editor/data_penindakan"><?= $title ?></a></li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
...
<script>
    ...
    $(document).on('click', '#cek_kendaraan', function(e) {
        ...
        $.ajax({
            url: '/editor/data_penindakan/getDataKendaraan',
            method: 'get',
            dataType: 'JSON',
            // contentType: false,
            processData: true,
    ...
    $("#tambah_data").submit(function(e) {
        ...
        $.ajax({
            url: '/editor/data_penindakan/insert',
            method: 'post',
            dataType: 'JSON',
            data: {
                ukpd_id: ukpd_id,
