    ...
    <div class="pagetitle">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/editor/pengeluaran_kendaraan"><?= $title ?></a></li>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if ($pengeluaran_kendaraan->status_kendaraan_id == 3) :  ?>
                                                        <?php if ($pengeluaran_kendaraan->pengantar_sidang == null) : ?>
                                                            <a href="/editor/cetak_pengantar/<?= $pengeluaran_kendaraan->id ?>" class="btn btn-sm btn-outline-primary" target="_blank">
                                                    ...
                                                    <?php if ($pengeluaran_kendaraan->status_kendaraan_id == 2) : ?>
                                                        <?php if ($pengeluaran_kendaraan->pengantar_sidang != null) : ?>
                                                            <a href="/editor/cetak_pdf/<?= $pengeluaran_kendaraan->id ?>" target="_blank" class="btn btn-sm btn-outline-primary">
                                                                <i class="bi bi-file-pdf"></i>
                                                            </a>
...
<div class="modal fade" id="laporanModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_laporan" autocomplete="off" class="row g-3" action="/editor/cetak_laporan" method="post">
                    <?= csrf_field(); ?>
...
<script>
    ...
    $("#search_kendaraan").submit(function(e) {
        ...
        $.ajax({
            url: '/editor/pengeluaran_kendaraan/search',
            method: 'get',
            dataType: 'JSON',
            data: {
                    ...
                    if (response.data_penindakan.length > 0) {
                        ...
                        response.data_penindakan.forEach(function(e) {
                            data += `<tr>
                                     ...
                                     <td> <a href="/editor/pengeluaran_kendaraan/form_insert/${e.nomor_bap}" id="data_button" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil-square"> Lengkapi </i>
                                     </a> </td>
                                 </tr>`;
                        })
    ...
    $(document).on('click', "#delete", function(e) {
        ...
        $.ajax({
            url: '/editor/pengeluaran_kendaraan/edit',
            method: 'get',
            dataType: 'JSON',
            data: {
                id: id,
    ...
    $("#delete_form").submit(function(e) {
        ...
        $.ajax({
            url: '/editor/pengeluaran_kendaraan/delete',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
    ...
    $("#edit_data").submit(function(e) {
        ...
        $.ajax({
            url: '/editor/pengeluaran_kendaraan/update',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
            ...
            success: function(response) {
                ...
                if (response.error) {
                    ...
                    setTimeout(function() {
                        window.location.href = '/editor/pengeluaran_kendaraan/';
                    }, 1000)
                }
            },
            error: function() {
    ...
    $("#form_ajukan_pengeluaran").submit(function(e) {
        ...
        $.ajax({
            url: '/editor/pengeluaran_kendaraan/upload_pengantar',
            data: formData,
            dataType: 'json',
