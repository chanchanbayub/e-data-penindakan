    ...
    <div class="pagetitle">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/admin/jenis_kendaraan"><?= $title ?></a></li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                        ...
                        <div class="card recent-sales overflow-auto">
                            ...
                            <div class="filter">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <li><a type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#smallModal" data-bs-whatever="@mdo"><i class="bi bi-plus"></i> Tambah Jenis Kendaraan</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($jenis_kendaraan as $jenis_kendaraan) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-outline-warning" id="edit" data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?= $jenis_kendaraan->id ?>" type="button">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </button>
                                                    <button class="btn btn-sm btn-outline-danger" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?= $jenis_kendaraan->id ?>" type="button">
            ...
            <div class="modal-body">
                <form id="tambah_jenis_kendaraan" autocomplete="off">
                    ...
                    <div class="form-group">
                        <label for="jenis_kendaraan" class="col-form-label"><?= $title ?>:</label>
                        <input type="text" class="form-control" id="jenis_kendaraan" name="jenis_kendaraan" placeholder="bus kecil">
...
<div class="modal fade" id="deleteModal" tabindex="0">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Hapus jenis_kendaraan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="delete_form">
            ...
            success: function(response) {
                ...
                if (response.error) {
                    if (response.error.jenis_kendaraan) {
                        ...
                        $(".error-jenis_kendaraan-edit").html(response.error.jenis_kendaraan);
                    } else {
                        $("#jenis_kendaraan_edit").removeClass('is-invalid');
                        $(".error-jenis_kendaraan-edit").html('');
                    }
                } else {
                    Swal.fire({
                        icon: 'success',
