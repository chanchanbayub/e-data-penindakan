<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="/editor/dashboard">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="/editor/data_penindakan">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="/editor/pengeluaran_kendaraan">
