...
class DataPenindakanController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('operator/data_penindakan_v', $data);
    }
        ...
        if ($this->request->isAjax()) {
            ...
            return DataTable::of($data_penindakan)
                ->add('action', function ($row) {
                    return '<a href="/operator/data_penindakan/views/' . $row->nomor_bap . ' " class="btn btn-sm btn-outline-primary">
                               <i class="bi bi-eye"></i>
                            </a>';
                })
    ...
    public function update()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$this->validate([
                ...
                $statusKendaraan = $this->request->getVar('status_kendaraan_id');
