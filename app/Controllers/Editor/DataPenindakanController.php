...
use App\Models\Editor\DataPenindakanModel;
...
class DataPenindakanController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('editor/data_penindakan_v', $data);
    }
        ...
        if ($this->request->isAjax()) {
            ...
            return DataTable::of($data_penindakan)
                ->add('action', function ($row) {
                    return '<a href="/editor/data_penindakan/views/' . $row->nomor_bap . ' " class="btn btn-sm btn-outline-primary">
                               <i class="bi bi-eye"></i>
                            </a>';
                })
    ...
    public function views($nomor_bap)
    {
        ...
        return view('editor/detail_data_penindakan_v', $data);
    }
